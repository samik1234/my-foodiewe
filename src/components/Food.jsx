        ...
        <div>
          ...
          <div className='flex justify-between flex-wrap'>
            ...
            <button
              ...
              className='m-1 border-violet-600 text-violet-600 hover:bg-violet-600 hover:text-white'
            >
              Salads
            </button>
            <button
        ...
        {foods.map((item, index) => (
          ...
          >
            ...
            <div className='flex justify-between px-2 py-4'>
              <p className='font-bold raleway'>{item.name}</p>
              <p>
                <span className='bg-blue-800 text-white p-1 rounded-full'>
                  {item.price}
                </span>
              </p>
            </div>
